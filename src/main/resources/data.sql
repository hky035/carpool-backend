...
INSERT INTO post (author_id, title, description) VALUES (1, '마일리지 학업 관련 서비스 추가 요청', '학업 관련 마일리지 서비스가 도입되면 좋겠습니다.');

INSERT INTO post (author_id, title, description) VALUES (1, '마일리지 획득량 변동 요구', '카풀 서비스 이용 시 마일리지가 더 많이 쌓였으면 좋겠습니다.');

INSERT INTO post (author_id, title, description) VALUES (1, '클리커 앱 또는 출결앱 등과 연동 요규', '다른 교내 서비스 플랫폼과 연동이 되었으면 합니다.');
